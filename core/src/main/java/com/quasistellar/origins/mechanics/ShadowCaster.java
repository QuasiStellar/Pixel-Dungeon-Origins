...
package com.quasistellar.origins.mechanics;
...
public final class ShadowCaster {
	...
	public static void castShadow( int x, int y, boolean[] fieldOfView, int distance ) {
		...
		if (!Dungeon.level.losBlocking[pos+1]) {
			scanOctant(distance-1, fieldOfView, losBlocking, 1, x + 1, y, 0.0, 1.0, +1, -1, false);
			scanOctant(distance-1, fieldOfView, losBlocking, 1, x + 1, y, 0.0, 1.0, -1, +1, true);
			scanOctant(distance-1, fieldOfView, losBlocking, 1, x + 1, y, 0.0, 1.0, +1, +1, true);
			scanOctant(distance-1, fieldOfView, losBlocking, 1, x + 1, y, 0.0, 1.0, +1, +1, false);
			scanOctant(distance-1, fieldOfView, losBlocking, 1, x + 1, y, 0.0, 1.0, -1, +1, false);
			scanOctant(distance-1, fieldOfView, losBlocking, 1, x + 1, y, 0.0, 1.0, +1, -1, true);
		...
		if (!Dungeon.level.losBlocking[pos+Dungeon.level.width()]) {
			scanOctant(distance-1, fieldOfView, losBlocking, 1, x, y + 1, 0.0, 1.0, +1, -1, false);
			scanOctant(distance-1, fieldOfView, losBlocking, 1, x, y + 1, 0.0, 1.0, -1, +1, true);
			scanOctant(distance-1, fieldOfView, losBlocking, 1, x, y + 1, 0.0, 1.0, +1, +1, true);
			scanOctant(distance-1, fieldOfView, losBlocking, 1, x, y + 1, 0.0, 1.0, +1, +1, false);
			scanOctant(distance-1, fieldOfView, losBlocking, 1, x, y + 1, 0.0, 1.0, -1, +1, false);
			scanOctant(distance-1, fieldOfView, losBlocking, 1, x, y + 1, 0.0, 1.0, +1, -1, true);
