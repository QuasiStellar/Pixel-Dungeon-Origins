...
import com.quasistellar.origins.actors.blobs.WellWater;
...
import com.quasistellar.origins.actors.buffs.Shadows;
...
import com.quasistellar.origins.effects.particles.FlowParticle;
import com.quasistellar.origins.effects.particles.WindParticle;
...
import com.quasistellar.origins.levels.features.HighGrass;
import com.quasistellar.origins.levels.painters.Painter;
import com.quasistellar.origins.levels.rooms.special.MassGraveRoom;
import com.quasistellar.origins.levels.traps.Trap;
import com.quasistellar.origins.mechanics.ShadowCaster;
...
import com.quasistellar.origins.tiles.DungeonTileSheet;
...
public abstract class Level implements Bundlable {
	...
	public int viewDistance = Dungeon.hero.heroClass == HeroClass.WANDERER ? 8 : 6;
...
//			}
	...
	public void updateFieldOfView( Char c, boolean[] fieldOfView ) {
		...
		if (c.isAlive() && c == Dungeon.hero) {
			...
			else if (((Hero)c).heroClass == HeroClass.WANDERER) {
				for (Mob mob : mobs) {
					int p = mob.pos;
	...
	public String tileName( int tile ) {
		...
		switch (tile) {
			...
			case Terrain.ANVIL:
				return Messages.get(Level.class, "anvil_name");
			default:
	...
	public String tileDesc( int tile ) {
		...
		switch (tile) {
			...
			case Terrain.ANVIL:
				return Messages.get(Level.class, "anvil_desc");
			case Terrain.EMPTY_WELL:
