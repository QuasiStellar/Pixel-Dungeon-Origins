...
package com.quasistellar.origins.sprites;
...
public class ItemSpriteSheet {
	...
	static{
		...
		assignItemRect(STONE_HOLDER,    14, 11);
	}
	...
	private static final int MELEE_WEP_PART1=                               xy(1, 5);   //9 slots
	public static final int KNUCKLEDUSTER   = MELEE_WEP_PART1+0;
	public static final int STUDDED_KNUCKLE = MELEE_WEP_PART1+1;
	public static final int IRON_GAUNTLET   = MELEE_WEP_PART1+2;
	public static final int STILETTO        = MELEE_WEP_PART1+3;
	public static final int DIRK            = MELEE_WEP_PART1+4;
	public static final int FOIL            = MELEE_WEP_PART1+5;
	public static final int SHORTSWORD      = MELEE_WEP_PART1+6;
	public static final int BROADSWORD      = MELEE_WEP_PART1+7;
	public static final int CLAYMORE        = MELEE_WEP_PART1+8;
	static{
		assignItemRect(KNUCKLEDUSTER,   15, 10);
		assignItemRect(STUDDED_KNUCKLE, 15, 12);
		assignItemRect(IRON_GAUNTLET,   13, 15);
		assignItemRect(STILETTO,        13, 14);
		assignItemRect(DIRK,            13, 14);
		assignItemRect(FOIL,            16, 16);
		assignItemRect(SHORTSWORD,      13, 13);
		assignItemRect(BROADSWORD,      15, 15);
		assignItemRect(CLAYMORE,        16, 16);
	}

	private static final int MELEE_WEP_PART2      =                               xy(1, 6);   //9 slots
	public static final int HATCHET               = MELEE_WEP_PART2+0;
	public static final int BATTLEAXE             = MELEE_WEP_PART2+1;
	public static final int GREATAXE              = MELEE_WEP_PART2+2;
	public static final int MACE                  = MELEE_WEP_PART2+3;
	public static final int CUDGEL                = MELEE_WEP_PART2+4;
	public static final int FLAIL                 = MELEE_WEP_PART2+5;
	public static final int PIKE                  = MELEE_WEP_PART2+6;
	public static final int GLAIVE                = MELEE_WEP_PART2+7;
	public static final int HALBERD               = MELEE_WEP_PART2+8;
	static{
		assignItemRect(HATCHET,         12, 14);
		assignItemRect(BATTLEAXE,       16, 16);
	...
	private static final int MELEE_WEP_PART3      =                               xy(1, 7);   //1 slot
	public static final int STAFF           = MELEE_WEP_PART3+0;
	static{
		assignItemRect(STAFF,           16, 16);
	}
	...
	public static final int STONE_FEHO     = STONES+0;
	public static final int STONE_URUZ     = STONES+1;
	public static final int STONE_THURS    = STONES+2;
	public static final int STONE_ANSUZ    = STONES+3;
	public static final int STONE_WYNN     = STONES+4;
	public static final int STONE_HAGLAZ   = STONES+5;
	public static final int STONE_JERA     = STONES+6;
	public static final int STONE_EIWAZ    = STONES+7;
	public static final int STONE_PERTHO   = STONES+8;
	public static final int STONE_ALGIZ    = STONES+9;
	public static final int STONE_EHWAZ    = STONES+10;
	public static final int STONE_DAGAZ    = STONES+11;
	static {
		for (int i = STONES; i < STONES+16; i++)
			assignItemRect(i, 14, 11);
	}

	private static final int STONES_2      =                                xy(1, 22);  //16 slots
	public static final int STONE_KAUNAN   = STONES_2+0;
	public static final int STONE_SOWILO   = STONES_2+1;
	public static final int STONE_LAGUZ    = STONES_2+2;
	public static final int STONE_YNGVI    = STONES_2+3;
	public static final int STONE_GYFU     = STONES_2+4;
	public static final int STONE_RAIDO    = STONES_2+5;
	public static final int STONE_ISAZ     = STONES_2+6;
	public static final int STONE_MANNAZ   = STONES_2+7;
	public static final int STONE_NAUDIZ   = STONES_2+8;
	public static final int STONE_BERKANAN = STONES_2+9;
	public static final int STONE_ODAL     = STONES_2+10;
	public static final int STONE_TIWAZ    = STONES_2+11;
	static {
		for (int i = STONES_2; i < STONES_2+16; i++)
			assignItemRect(i, 14, 11);
	}
	...
	private static final int TRASH      =                                   xy(1, 27);  //16 slots
	public static final int BLADE       = TRASH+0;
	public static final int CUTTER      = TRASH+1;
	public static final int GLANDULE    = TRASH+2;
	public static final int HANDLE      = TRASH+3;
	public static final int STICK       = TRASH+4;
	public static final int STONE       = TRASH+5;
	static{
		assignItemRect(BLADE,       11, 11);
		assignItemRect(CUTTER,      11,  8);
		assignItemRect(GLANDULE,    8,  8);
		assignItemRect(HANDLE,      7,  7);
		assignItemRect(STICK,       11, 11);
		assignItemRect(STONE,       9,  9);
	}
