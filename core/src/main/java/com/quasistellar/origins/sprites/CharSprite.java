...
import com.quasistellar.origins.effects.DarkBlock;
import com.quasistellar.origins.effects.EmoIcon;
import com.quasistellar.origins.effects.FloatingText;
import com.quasistellar.origins.effects.IceBlock;
import com.quasistellar.origins.effects.Shield;
import com.quasistellar.origins.effects.Speck;
import com.quasistellar.origins.effects.Splash;
import com.quasistellar.origins.effects.TorchHalo;
...
import com.quasistellar.origins.effects.particles.SnowParticle;
...
import com.quasistellar.origins.ui.CharHealthIndicator;
	...
	public void add( State state ) {
		switch (state) {
			...
			case ILLUMINATED:
				...
				break;
			case SHIELDED:
				GameScene.effect( shield = new Shield( this ) );
				break;
			case CHILLED:
				chilled = emitter();
