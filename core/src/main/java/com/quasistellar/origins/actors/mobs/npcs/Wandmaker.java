...
package com.quasistellar.origins.actors.mobs.npcs;
...
import com.quasistellar.origins.levels.rooms.special.RotGardenRoom;
import com.quasistellar.origins.levels.rooms.standard.RitualSiteRoom;
...
import com.quasistellar.origins.sprites.WandmakerSprite;
import com.quasistellar.origins.windows.WndQuest;
import com.quasistellar.origins.windows.WndWandmaker;
...
public class Wandmaker extends NPC {
	...
	public static class Quest {
		...
		public static ArrayList<Room> spawnRoom( ArrayList<Room> rooms) {
			questRoomSpawned = false;
			if (!spawned && (type != 0 || Dungeon.depth == 1 )) {
