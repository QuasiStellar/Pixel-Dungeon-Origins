...
package com.quasistellar.origins.tiles;
...
public class DungeonTileSheet {
	...
	public static HashSet<Integer> waterStitcheable = new HashSet<>(Arrays.asList(
			...
			Terrain.SIGN, Terrain.WELL, Terrain.STATUE, Terrain.ALCHEMY, Terrain.ANVIL,
	...
	public static final int FLAT_ANVIL          = FLAT_OTHER+6;
	...
	public static final int RAISED_ANVIL            = RAISED_OTHER+6;
	...
	public static final int ANVIL_OVERHANG              = WALL_OVERHANG+25;
	...
	static {
		...
		directFlatVisuals.put(Terrain.ANVIL,            FLAT_ANVIL);
