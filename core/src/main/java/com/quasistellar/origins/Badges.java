...
import com.quasistellar.origins.actors.mobs.Acidic;
import com.quasistellar.origins.actors.mobs.Albino;
import com.quasistellar.origins.actors.mobs.Bandit;
import com.quasistellar.origins.actors.mobs.Mob;
import com.quasistellar.origins.actors.mobs.Senior;
import com.quasistellar.origins.actors.mobs.Shielded;
...
public class Badges {
	...
	public enum Badge {
		...
		DEATH_FROM_FATIGUE( 35 ),
		YASD( 34, true ),
		BOSS_SLAIN_1_CHEVALIER,
		BOSS_SLAIN_1_ENCHANTER,
		BOSS_SLAIN_1_WANDERER,
		BOSS_SLAIN_1( 12 ),
		BOSS_SLAIN_2( 13 ),
		BOSS_SLAIN_3( 14 ),
		BOSS_SLAIN_4( 15 ),
	...
	public static void validateDeathFromFatigue() {
		Badge badge = Badge.DEATH_FROM_FATIGUE;
		local.add( badge );
		displayBadge( badge );
	...
	private static void validateYASD() {
		if (global.contains( Badge.DEATH_FROM_FIRE ) &&
			...
			global.contains( Badge.DEATH_FROM_FATIGUE)) {
		...
		if (badge != null) {
			...
			if (badge == Badge.BOSS_SLAIN_1) {
				switch (Dungeon.hero.heroClass) {
					case CHEVALIER:
					badge = Badge.BOSS_SLAIN_1_CHEVALIER;
					break;
					case ENCHANTER:
					badge = Badge.BOSS_SLAIN_1_ENCHANTER;
					break;
					case WANDERER:
					badge = Badge.BOSS_SLAIN_1_WANDERER;
					break;
				}
				local.add( badge );
				...
				if (global.contains( Badge.BOSS_SLAIN_1_CHEVALIER ) &&
					global.contains( Badge.BOSS_SLAIN_1_ENCHANTER ) &&
					global.contains( Badge.BOSS_SLAIN_1_WANDERER )) {
			...
			if (badge == Badge.BOSS_SLAIN_3) {
				...
				if (global.contains( Badge.BOSS_SLAIN_3_WARLOCK ) &&
	...
	public static void validateMastery() {
		...
		switch (Dungeon.hero.heroClass) {
		case CHEVALIER:
			badge = Badge.MASTERY_CHEVALIER;
			break;
		case ENCHANTER:
			badge = Badge.MASTERY_ENCHANTER;
			break;
		case WANDERER:
			badge = Badge.MASTERY_WANDERER;
			break;
		}
	...
	public static void validateVictory() {
		...
		switch (Dungeon.hero.heroClass) {
		case CHEVALIER:
			badge = Badge.VICTORY_CHEVALIER;
			break;
		case ENCHANTER:
			badge = Badge.VICTORY_ENCHANTER;
			break;
		case WANDERER:
			badge = Badge.VICTORY_WANDERER;
			break;
		}
		local.add( badge );
		if (!global.contains( badge )) {
		...
		if (global.contains( Badge.VICTORY_CHEVALIER ) &&
			global.contains( Badge.VICTORY_ENCHANTER ) &&
			global.contains( Badge.VICTORY_WANDERER )) {
	...
	public static List<Badge> filtered( boolean global ) {
		...
		leaveBest( filtered, Badge.DEATH_FROM_FATIGUE, Badge.YASD );
