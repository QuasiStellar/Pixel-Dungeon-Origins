...
package com.quasistellar.origins.messages;
...
public class Messages {
	...
	private static String[] prop_files = new String[]{
			"com.quasistellar.origins.messages.actors.actors",
			"com.quasistellar.origins.messages.items.items",
			"com.quasistellar.origins.messages.journal.journal",
			"com.quasistellar.origins.messages.levels.levels",
			"com.quasistellar.origins.messages.plants.plants",
			"com.quasistellar.origins.messages.scenes.scenes",
			"com.quasistellar.origins.messages.ui.ui",
			"com.quasistellar.origins.messages.windows.windows",
			"com.quasistellar.origins.messages.misc.misc"
	};
	...
	public static String get(Class c, String k, Object...args){
		String key;
		if (c != null){
			key = c.getName().replace("com.quasistellar.origins.", "");
			key += "." + k;
		} else
			key = k;
