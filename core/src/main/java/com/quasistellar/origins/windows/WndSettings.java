...
import com.quasistellar.origins.ui.CheckBox;
import com.quasistellar.origins.ui.OptionSlider;
import com.quasistellar.origins.ui.RedButton;
import com.quasistellar.origins.ui.Toolbar;
		...
		public DisplayTab() {
			...
			OptionSlider scale = new OptionSlider(Messages.get(this, "scale"),
				...
				protected void onChange() {
					if (getSelectedValue() != SPDSettings.scale()) {
						...
						Origins.switchNoFade((Class<? extends PixelScene>) Origins.scene().getClass(), new Game.SceneChangeCallback() {
							@Override
			...
			CheckBox chkSaver = new CheckBox( Messages.get(this, "saver") ) {
				...
				protected void onClick() {
					...
					if (checked()) {
						checked(!checked());
						Origins.scene().add(new WndOptions(
