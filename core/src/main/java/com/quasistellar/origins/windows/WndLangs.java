...
import com.quasistellar.origins.scenes.TitleScene;
...
public class WndLangs extends WndTitledMessage {//Window {

	public WndLangs() {
		super( Icons.WARNING.get(), Messages.get(WndLangs.class, "title"), Messages.get(WndLangs.class, "message") );
	}
...
//					Origins.switchNoFade(TitleScene.class, new Game.SceneChangeCallback() {
//						@Override
