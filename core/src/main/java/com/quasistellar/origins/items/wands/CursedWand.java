...
import com.quasistellar.origins.actors.blobs.ConfusionGas;
import com.quasistellar.origins.actors.blobs.Fire;
import com.quasistellar.origins.actors.blobs.ParalyticGas;
import com.quasistellar.origins.actors.blobs.Regrowth;
...
import com.quasistellar.origins.actors.mobs.Mimic;
import com.quasistellar.origins.actors.mobs.Mob;
import com.quasistellar.origins.actors.mobs.npcs.Sheep;
...
import com.quasistellar.origins.levels.traps.CursingTrap;
import com.quasistellar.origins.levels.traps.ShockingTrap;
import com.quasistellar.origins.levels.traps.SummoningTrap;
import com.quasistellar.origins.mechanics.OldBallistica;
import com.quasistellar.origins.messages.Languages;
...
import com.quasistellar.origins.ui.TargetHealthIndicator;
...
public class CursedWand {
	...
	public static void cursedZap(final Wand wand, final Hero user, final OldBallistica bolt){
	...
	private static void commonEffect(final Wand wand, final Hero user, final OldBallistica bolt){
		switch(Random.Int(4)){
	...
	private static void uncommonEffect(final Wand wand, final Hero user, final OldBallistica bolt){
		switch(Random.Int(4)){
	...
	private static void rareEffect(final Wand wand, final Hero user, final OldBallistica bolt){
		switch(Random.Int(4)){
	...
	private static void veryRareEffect(final Wand wand, final Hero user, final OldBallistica bolt){
		switch(Random.Int(4)){
	...
	private static void cursedFX(final Hero user, final OldBallistica bolt, final Callback callback){
