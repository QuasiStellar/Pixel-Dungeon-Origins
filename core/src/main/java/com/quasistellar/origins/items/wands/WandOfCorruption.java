...
import com.quasistellar.origins.actors.buffs.PinCushion;
...
import com.quasistellar.origins.actors.mobs.Bee;
import com.quasistellar.origins.actors.mobs.King;
import com.quasistellar.origins.actors.mobs.Mimic;
import com.quasistellar.origins.actors.mobs.Mob;
import com.quasistellar.origins.actors.mobs.Piranha;
import com.quasistellar.origins.actors.mobs.Statue;
import com.quasistellar.origins.actors.mobs.Swarm;
import com.quasistellar.origins.actors.mobs.Wraith;
...
public class WandOfCorruption extends Wand {
	...
	private void debuffEnemy( Mob enemy, HashMap<Class<? extends Buff>, Float> category ){
		...
		if (debuffCls != null){
			Buff.append(enemy, debuffCls, 6 + 5*3);
		} else {
