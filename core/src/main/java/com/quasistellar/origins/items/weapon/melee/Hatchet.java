...
public class Hatchet extends MeleeWeapon {
	...
	public static class Break extends Scheme {
		...
		public boolean testIngredients(ArrayList<Item> ingredients) {
			...
			return (ingredients.get(0) instanceof Hatchet);
		}
	...
	public static class Assemble extends Scheme {
		...
		public boolean testIngredients(ArrayList<Item> ingredients) {
			...
			if ((ingredients.get(0) instanceof Stick) && (ingredients.get(1) instanceof Cutter) && (ingredients.get(2) instanceof Cutter)) return true;
			else if ((ingredients.get(0) instanceof Cutter) && (ingredients.get(1) instanceof Stick) && (ingredients.get(2) instanceof Cutter)) return true;
			else if ((ingredients.get(0) instanceof Cutter) && (ingredients.get(1) instanceof Cutter) && (ingredients.get(2) instanceof Stick)) return true;
			else return false;
		}
