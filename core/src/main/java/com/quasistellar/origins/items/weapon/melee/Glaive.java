...
public class Glaive extends MeleeWeapon {
	...
	public static class Break extends Scheme {
		...
		public boolean testIngredients(ArrayList<Item> ingredients) {
			...
			return (ingredients.get(0) instanceof Glaive);
		}
	...
	public static class Assemble extends Scheme {
		...
		public boolean testIngredients(ArrayList<Item> ingredients) {
			...
			if ((ingredients.get(0) instanceof Pike) && (ingredients.get(1) instanceof Glandule) && (ingredients.get(2) instanceof Stone)) return true;
			else if ((ingredients.get(0) instanceof Pike) && (ingredients.get(1) instanceof Stone) && (ingredients.get(2) instanceof Glandule)) return true;
			else if ((ingredients.get(0) instanceof Stone) && (ingredients.get(1) instanceof Pike) && (ingredients.get(2) instanceof Glandule)) return true;
			else if ((ingredients.get(0) instanceof Stone) && (ingredients.get(1) instanceof Glandule) && (ingredients.get(2) instanceof Pike)) return true;
			else if ((ingredients.get(0) instanceof Glandule) && (ingredients.get(1) instanceof Pike) && (ingredients.get(2) instanceof Stone)) return true;
			else if ((ingredients.get(0) instanceof Glandule) && (ingredients.get(1) instanceof Stone) && (ingredients.get(2) instanceof Pike)) return true;
			else return false;
		}
