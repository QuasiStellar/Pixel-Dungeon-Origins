...
public class Dirk extends MeleeWeapon {
	...
	@Override
	public int ave() {
		return  Math.round((2 +    //2 base, down from 4
	...
	public static class Break extends Scheme {
		...
		public boolean testIngredients(ArrayList<Item> ingredients) {
			...
			return (ingredients.get(0) instanceof Dirk);
		}
	...
	public static class Assemble extends Scheme {
		...
		public boolean testIngredients(ArrayList<Item> ingredients) {
			...
			if ((ingredients.get(0) instanceof Stiletto) && (ingredients.get(1) instanceof Blade) && (ingredients.get(2) instanceof Handle)) return true;
			else if ((ingredients.get(0) instanceof Stiletto) && (ingredients.get(1) instanceof Handle) && (ingredients.get(2) instanceof Blade)) return true;
			else if ((ingredients.get(0) instanceof Handle) && (ingredients.get(1) instanceof Stiletto) && (ingredients.get(2) instanceof Blade)) return true;
			else if ((ingredients.get(0) instanceof Handle) && (ingredients.get(1) instanceof Blade) && (ingredients.get(2) instanceof Stiletto)) return true;
			else if ((ingredients.get(0) instanceof Blade) && (ingredients.get(1) instanceof Stiletto) && (ingredients.get(2) instanceof Handle)) return true;
			else if ((ingredients.get(0) instanceof Blade) && (ingredients.get(1) instanceof Handle) && (ingredients.get(2) instanceof Stiletto)) return true;
			else return false;
		}
