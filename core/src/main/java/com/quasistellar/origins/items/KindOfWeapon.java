...
abstract public class KindOfWeapon extends EquipableItem {
	...
	protected static final float TIME_TO_EQUIP = 0.5f;
	...
	public int damageRoll( Char owner ) {
		return Math.round(Random.Gauss( ave() ));
	}
	...
	public boolean hasStone(Runestone stone) { return false; }
