...
public class Mace extends MeleeWeapon {
	...
	public static class Break extends Scheme {
		...
		public boolean testIngredients(ArrayList<Item> ingredients) {
			...
			return (ingredients.get(0) instanceof Mace);
		}
	...
	public static class Assemble extends Scheme {
		...
		public boolean testIngredients(ArrayList<Item> ingredients) {
			...
			if ((ingredients.get(0) instanceof Stick) && (ingredients.get(1) instanceof Stone) && (ingredients.get(2) instanceof Stone)) return true;
			else if ((ingredients.get(0) instanceof Stone) && (ingredients.get(1) instanceof Stick) && (ingredients.get(2) instanceof Stone)) return true;
			else if ((ingredients.get(0) instanceof Stone) && (ingredients.get(1) instanceof Stone) && (ingredients.get(2) instanceof Stick)) return true;
			else return false;
		}
