...
import com.quasistellar.origins.actors.buffs.Amok;
...
import com.quasistellar.origins.actors.mobs.npcs.Blacksmith;
import com.quasistellar.origins.actors.mobs.npcs.Ghost;
import com.quasistellar.origins.actors.mobs.npcs.Imp;
...
import com.quasistellar.origins.levels.CavesBossLevel;
import com.quasistellar.origins.levels.CavesLevel;
import com.quasistellar.origins.levels.CityBossLevel;
import com.quasistellar.origins.levels.CityLevel;
import com.quasistellar.origins.levels.DeadEndLevel;
import com.quasistellar.origins.levels.HallsBossLevel;
import com.quasistellar.origins.levels.HallsLevel;
import com.quasistellar.origins.levels.LastLevel;
import com.quasistellar.origins.levels.LastShopLevel;
import com.quasistellar.origins.levels.Level;
import com.quasistellar.origins.levels.PrisonBossLevel;
import com.quasistellar.origins.levels.PrisonLevel;
import com.quasistellar.origins.levels.SewerBossLevel;
import com.quasistellar.origins.levels.SewerLevel;
import com.quasistellar.origins.levels.rooms.secret.SecretRoom;
import com.quasistellar.origins.levels.rooms.special.SpecialRoom;
import com.quasistellar.origins.messages.Messages;
import com.quasistellar.origins.scenes.GameScene;
import com.quasistellar.origins.scenes.StartScene;
import com.quasistellar.origins.ui.QuickSlotButton;
import com.quasistellar.origins.utils.BArray;
import com.quasistellar.origins.utils.DungeonSeed;
...
public class Dungeon {
	...
	public static boolean shopOnLevel() {
		return depth == 4 || depth == 8 || depth == 12 || depth == 16 || depth == 24;
	}

	public static boolean laboratoryOnLevel() {
		return depth == 3 || depth == 6 || depth == 9 || depth == 12 || depth == 18 || depth == 21 || depth == 24;
	}

	public static boolean smithyOnLevel() {
		return depth == 2 || depth == 4 || depth == 6 || depth == 8 || depth == 12 || depth == 14 || depth == 16 || depth == 18 || depth == 22 || depth == 24;
	}
