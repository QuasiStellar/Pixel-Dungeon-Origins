...
import com.quasistellar.origins.ui.ChangesButton;
import com.quasistellar.origins.ui.ExitButton;
import com.quasistellar.origins.ui.LanguageButton;
import com.quasistellar.origins.ui.PrefsButton;
...
//		placeTorch(title.x + 22, title.y + 36);
//		placeTorch(title.x + title.width - 22, title.y + 36);
		...
		DashboardItem btnBadges = new DashboardItem( Messages.get(this, "badges"), 3 ) {
			...
			protected void onClick() {
				Origins.switchNoFade( BadgesScene.class );
			}
		};
		add(btnBadges);
		...
		DashboardItem btnAbout = new DashboardItem( Messages.get(this, "about"), 1 ) {
			@Override
			protected void onClick() {
				Origins.switchNoFade( AboutScene.class );
			}
		};
		add( btnAbout );
		...
		DashboardItem btnPlay = new DashboardItem( Messages.get(this, "play"), 0 ) {
			@Override
			protected void onClick() {
				Origins.switchNoFade( StartScene.class );
			}
		};
		add( btnPlay );
		...
		DashboardItem btnRankings = new DashboardItem( Messages.get(this, "rankings"), 2 ) {
			@Override
			protected void onClick() {
				Origins.switchNoFade( RankingsScene.class );
			}
		};
		add( btnRankings );
