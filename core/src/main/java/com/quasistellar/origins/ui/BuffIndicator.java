...
import com.quasistellar.origins.windows.WndInfoBuff;
...
public class BuffIndicator extends Component {
	...
	public static final int FATIGUE     = 43;
	public static final int RESTED      = 44;
	public static final int AURA        = 45;
	...
	protected void layout() {
		...
		for (BuffIcon icon : buffIcons.values()){
			icon.updateIcon();
			icon.setRect(x + pos * (SIZE + 2), y, 9, 9);
			pos++;
		}
	}
